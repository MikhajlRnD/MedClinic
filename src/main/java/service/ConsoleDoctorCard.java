    ...
    public void console() {
        ...
        while (true){
            ...
            if (choice.intValue() == 1) {
                ...
                log.creedLog("Создана новая карточка", doctorCard, LocalDateTime.now());
                ...
                log.creedLog("Обновлена карточка", doctorCard, LocalDateTime.now());
                ...
                log.creedLog("Удалена карточка", doctorCard, LocalDateTime.now());
